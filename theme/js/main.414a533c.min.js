...
function onHeightChange(e){var height=getHeight();var filter=getFilter();updateTable(height,filter);_.each(graphData,function(config){window.setTimeout(function(){updateGraph(config.gnode,config.filtered,config.data.slice(),config.layout,height)});});}
